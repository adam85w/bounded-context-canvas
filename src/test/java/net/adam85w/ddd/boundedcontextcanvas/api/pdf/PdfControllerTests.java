...
public class PdfControllerTests {
    ...
    private final String ENDPOINT = "/api/bounded-context-canvas/pdf";
    ...
    public void unrecognizedTemplateNameShouldReturnError() throws IOException {
        ...
        ErrorResponse response = objectMapper.readValue(responseEntity.getBody(), ErrorResponse.class);
        Assertions.assertThat(response.getMessage()).isEqualTo("Template name is incorrect or does not support the PDF type.");
    }
