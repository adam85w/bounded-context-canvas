...
public class HtmlControllerTests {
    ...
    private final String ENDPOINT = "/api/bounded-context-canvas/html";
    ...
    public void unrecognizedTemplateNameShouldReturnError() throws IOException {
        ...
        ErrorResponse response = objectMapper.readValue(responseEntity.getBody(), ErrorResponse.class);
        Assertions.assertThat(response.getMessage()).isEqualTo("Template name is incorrect or does not support the HTML type.");
    }
